...
class BottomMenu(QWidget):
    ...
    def __init__(self, parent=None, menu_type="main_window"):
        ...
        if menu_type == "main_window":
            ...
            self.create_button(MENU_ICON, parent.main_page.close_browser,
                               self.nav_layout)
            ...
            self.search_button = self.create_button(SEARCH_ICON, self.search_box_activate, self.nav_layout)
            ...
            self.create_button(FORWARD_ARROW_ICON, parent.browser.forward, self.nav_layout)

            self.nav_layout.setStretch(1, 1)

            if PLATFORM not in ['windows', 'linux']:
                self.create_button(EXIT_ICON, parent.main_page.main_window.close,
                                   self.nav_layout)
